...
export const PHOTOS: Photo[] = [
  // New Local Portraits
  {
    ...
    description: 'A confident, blue-suit professional portrait exuding approachability and competence.',
    metadata: { camera: 'Nikon Z9', lens: '85mm f/1.2 S', settings: '1/200s • f/2.0 • ISO 160' }
  },
  {
    id: '2',
    url: '/assets/portrait-2.png',
    category: 'Location',
    title: 'Partners in Service',
    description: 'Two officers in uniform standing back-to-back, symbolizing solidarity and dedication.',
    metadata: { camera: 'Sony A1', lens: '50mm f/1.2 GM', settings: '1/160s • f/2.8 • ISO 400' }
  },
  {
    id: '3',
    url: '/assets/portrait-3.png',
    category: 'Corporate',
    title: 'Executive Vision',
    description: 'A polished business portrait featuring a sharp suit and a subtle, confident expression.',
    metadata: { camera: 'Canon EOS R3', lens: '85mm f/1.2L', settings: '1/200s • f/1.8 • ISO 200' }
  },
  {
    id: '4',
    url: '/assets/portrait-4.png',
    category: 'Studio',
    title: 'Minimalist Elegance',
    description: 'A clean, high-key studio portrait focusing on warmth and professional grace.',
    metadata: { camera: 'Fujifilm GFX 100S', lens: '110mm f/2', settings: '1/125s • f/5.6 • ISO 100' }
  },
  {
    id: '5',
    url: '/assets/portrait-5.png',
    category: 'Headshots',
